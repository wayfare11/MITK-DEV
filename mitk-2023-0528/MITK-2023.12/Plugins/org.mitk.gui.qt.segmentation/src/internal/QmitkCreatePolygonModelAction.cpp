...
void QmitkCreatePolygonModelAction::Run(const QList<DataNode::Pointer> &selectedNodes)
{
  ...
  try
  {
    ...
    itk::SimpleMemberCommand<QmitkCreatePolygonModelAction>::Pointer successCommand =
      itk::SimpleMemberCommand<QmitkCreatePolygonModelAction>::New();
    ...
    itk::SimpleMemberCommand<QmitkCreatePolygonModelAction>::Pointer errorCommand =
      itk::SimpleMemberCommand<QmitkCreatePolygonModelAction>::New();
    ...
    if (m_IsSmoothed)
    {
      ...
      surfaceFilter->SetParameter("Gaussian SD",
                                  sqrt(smoothing)); // use sqrt to account for setting of variance in preferences
